...
void FrameCore::draw_rect(int x1, int y1, int x2, int y2, int color)
{

	this->plot_line(x1, y1, x1,y2 , color);
	this->plot_line(x1, y1, x2, y1,  color);
	this->plot_line(x2, y1, x2, y2 , color);
	this->plot_line(x1, y2, x2, y2, color);

	//fill lines
	for(int i =x1; i<x2; i++)
	{
		this->plot_line(i, y1, i,y2 , color);
	}
}
